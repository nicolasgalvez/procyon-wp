...
## [1.0.3](https://github.com/nicolasgalvez/procyon-wp/compare/v1.0.5...v1.0.3) (2026-05-19)


### Bug Fixes

* **ci:** drop PAT from release-please, use default GITHUB_TOKEN ([#15](https://github.com/nicolasgalvez/procyon-wp/issues/15)) ([b9676f3](https://github.com/nicolasgalvez/procyon-wp/commit/b9676f338deb22a3a10ed37618e0ebb96f5d0327))
* remove node_modules/ from default rsync excludes ([#12](https://github.com/nicolasgalvez/procyon-wp/issues/12)) ([0024567](https://github.com/nicolasgalvez/procyon-wp/commit/002456799927a7995784f01fa6afcc5307abc2a1))
* skip backup when pushing new files that don't exist on remote ([96a29f7](https://github.com/nicolasgalvez/procyon-wp/commit/96a29f7d0b5823d137344c1cad77ef6fa68e64ad))
* upgrade to node 22 + npm@latest for OIDC trusted publishing ([#7](https://github.com/nicolasgalvez/procyon-wp/issues/7)) ([43ecfa9](https://github.com/nicolasgalvez/procyon-wp/commit/43ecfa97511de6af2c477a25c925548a4e76b56b))
* use node 24 for built-in npm 11 (OIDC trusted publishing) ([#8](https://github.com/nicolasgalvez/procyon-wp/issues/8)) ([4df80b3](https://github.com/nicolasgalvez/procyon-wp/commit/4df80b3d077e60abedcf7cc0ad622e3857bad994))
* use PAT for release-please to bypass org PR restriction ([9dfb1b0](https://github.com/nicolasgalvez/procyon-wp/commit/9dfb1b0bbb179270d1f9eb0b764f6280680acb9e))
* use PAT for release-please to bypass org PR restriction ([ca4bd6f](https://github.com/nicolasgalvez/procyon-wp/commit/ca4bd6f3ecdd0e65c85a9ab7aed5da5972bf7167))
* use yargs main entry to support Node 26 (PWC-1) ([#17](https://github.com/nicolasgalvez/procyon-wp/issues/17)) ([e2c9ff4](https://github.com/nicolasgalvez/procyon-wp/commit/e2c9ff4942e239831e0ba94882e322bb1de019d8))


### Miscellaneous Chores

* bump to 1.0.3 to skip existing npm versions ([#10](https://github.com/nicolasgalvez/procyon-wp/issues/10)) ([126160c](https://github.com/nicolasgalvez/procyon-wp/commit/126160c8379a79e09805378ad44381482cf85d41))
